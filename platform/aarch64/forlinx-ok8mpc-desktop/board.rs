...
pub const BOARD_NAME: &str = "forlinx-ok8mpc-desktop";
...
pub const ROOT_ZONE_MEMORY_REGIONS: [HvConfigMemoryRegion; 15] = [
    // Three disjoint banks total 2.5 GiB; see docs/forlinx-ok8mpc-memory.md.
    HvConfigMemoryRegion { mem_type: MEM_TYPE_RAM, physical_start: 0x80000000, virtual_start: 0x80000000, size: 0x12400000 },
    HvConfigMemoryRegion { mem_type: MEM_TYPE_RAM, physical_start: 0x94400000, virtual_start: 0x94400000, size: 0x57c00000 },
    HvConfigMemoryRegion { mem_type: MEM_TYPE_RAM, physical_start: 0x100000000, virtual_start: 0x100000000, size: 0x36000000 },
